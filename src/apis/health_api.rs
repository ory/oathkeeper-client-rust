...
pub enum IsInstanceReadyError {
    Status503(models::HealthNotReadyStatus),
    DefaultResponse(String),
    UnknownValue(serde_json::Value),
}
...
pub async fn is_instance_alive(configuration: &configuration::Configuration, ) -> Result<models::HealthStatus, Error<IsInstanceAliveError>> {
...
pub async fn is_instance_ready(configuration: &configuration::Configuration, ) -> Result<models::HealthStatus, Error<IsInstanceReadyError>> {
    let local_var_configuration = configuration;
